...
- Desktop Files for QuickMenuActions in hotkey.
- Feature nou la hotkey: Open Launcher with prefix, si userul da inputul.
- la normaltaskvbar ( nonexpand ) fa iconitele putin mai mari.
- Music player files with stupid ass name are not being loaded.