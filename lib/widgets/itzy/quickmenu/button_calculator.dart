  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _isHovered ? Design.accent.withAlpha(20) : widget.onSurface.withAlpha(10),
          borderRadius: BorderRadius.circular(8),
          border: Border.all(color: _isHovered ? Design.accent.withAlpha(40) : Colors.transparent),
        ),
        child: Row(
          children: <Widget>[
            // Variable name
            Container(
              ...
              child: Text(
                widget.entry.name,
                style: TextStyle(color: Design.accent, fontWeight: FontWeight.bold, fontSize: 13),
              ),
            ),
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            if (_isHovered) ...<Widget>[
                              ...
                              Icon(Icons.edit_rounded, size: 10, color: Design.accent.withAlpha(150)),
                            ],
                          ],
                        ),
                      ),
