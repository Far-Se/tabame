            ...
            child: Row(
              ...
              children: <Widget>[
                Icon(
                  icon,
                  size: 16,
                  color: selected ? Design.background : user.themeColors.text.withValues(alpha: 0.72),
                ),
                const SizedBox(width: 6),
                Flexible(
                  child: Text(
                    ...
                    style: theme.textTheme.labelLarge?.copyWith(
                      fontWeight: FontWeight.w700,
                      color: selected ? Design.background : user.themeColors.text.withValues(alpha: 0.78),
                    ),
                  ),
                ),
              ],
