            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                gradient: widget.active
                    ? LinearGradient(
                        ...
                        colors: <Color>[
                          widget.accent.withAlpha(45),
                          widget.accent.withAlpha(15),
                        ],
                      )
                    : null,
                color: widget.active ? null : (widget.onSurface.withAlpha(_hovered ? 14 : 0)),
                borderRadius: BorderRadius.circular(9),
                border: Border.all(
                  color: widget.active ? widget.accent.withAlpha(120) : widget.onSurface.withAlpha(_hovered ? 28 : 12),
                  width: 1,
                ),
              ...
              child: Center(
                child: Icon(
                  widget.icon,
                  size: 17,
                  color: widget.active ? widget.accent : widget.onSurface.withAlpha(_hovered ? 180 : 110),
                ),
              ),
            ),
          ),
...
class _CoverArt extends StatelessWidget {
  const _CoverArt({required this.item, required this.size, required this.accent, required this.onSurface});
  ...
  Widget build(BuildContext context) {
    final Widget fallback = Container(
      ...
      child: Icon(item.isFolder ? Icons.album_rounded : Icons.music_note_rounded, size: size * 0.38, color: accent),
    );
      ...
      child: AnimatedScale(
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: _hovered ? widget.accent.withAlpha(14) : widget.onSurface.withAlpha(7),
              borderRadius: BorderRadius.circular(10),
              border: Border.all(color: _hovered ? widget.accent.withAlpha(52) : widget.onSurface.withAlpha(14)),
            ),
            child: Row(
              ...
              children: <Widget>[
                _CoverArt(
                    item: widget.item,
                    size: widget.item.isFolder ? 36 : 46,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                          ...
                          if (widget.item.duration != null)
                            Padding(
                              ...
                              child: Text(_durationLabel(widget.item.duration!),
                                  style: TextStyle(fontSize: 10, color: widget.onSurface.withAlpha(110))),
                            ),
                        ],
                      ),
                      ...
                      Text(
                        ...
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(fontSize: 11, color: widget.onSurface.withAlpha(130)),
                      ),
                      if (_secondaryMeta != null) ...<Widget>[
                        ...
                        Text(
                          ...
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(fontSize: 10.5, color: widget.onSurface.withAlpha(102)),
                        ),
                      ],
                    ],
                  ),
                        ...
                        (_RowAction action) => Tooltip(
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Icon(action.icon, size: 15, color: widget.accent),
                            ),
                          ),
                        ),
                      )
      ...
      child: AnimatedScale(
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: _hovered ? widget.accent.withAlpha(14) : widget.onSurface.withAlpha(8),
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: _hovered ? widget.accent.withAlpha(52) : widget.onSurface.withAlpha(18)),
            ),
            child: Row(
              children: <Widget>[
                _IconPill(icon: Icons.playlist_play_rounded, accent: widget.accent),
                const SizedBox(width: 10),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text(widget.playlist.name,
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: widget.onSurface)),
                      const SizedBox(height: 2),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            _IconPill(icon: category.icon, accent: accent),
            const SizedBox(width: 10),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            Icon(Icons.playlist_add_check_rounded, size: 17, color: accent),
            ...
            Text(
              "${playlist.songCount}",
              style: TextStyle(fontSize: 10.5, fontWeight: FontWeight.w700, color: onSurface.withAlpha(120)),
            ),
          ],
        ),
      ),
...
class _CompactQueueRow extends StatelessWidget {
  const _CompactQueueRow(
      {required this.item, required this.active, required this.accent, required this.onSurface, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            _CoverArt(item: item, size: 24, accent: accent, onSurface: onSurface),
            const SizedBox(width: 8),
            Expanded(
  ...
  Widget build(BuildContext context) {
    return CustomTooltip(
      ...
      child: PopupMenuButton<_PlayerTrackMenuAction>(
        ...
        tooltip: "",
        color: Color.alphaBlend(accent.withAlpha(16), Theme.of(context).colorScheme.surface),
        surfaceTintColor: accent.withAlpha(30),
        elevation: 8,
        ...
        child: Container(
          ...
          child: Icon(Icons.more_vert_rounded, size: 18, color: onSurface.withAlpha(170)),
        ),
      ),
    );
  }
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              color: widget.isPrimary
                  ? null
                  : (widget.active ? widget.accent.withAlpha(30) : widget.onSurface.withAlpha(8)),
              shape: BoxShape.circle,
              border: Border.all(
                color: widget.isPrimary
                    ? widget.accent.withAlpha(180)
                    : (widget.active ? widget.accent.withAlpha(100) : widget.onSurface.withAlpha(20)),
              ),
              boxShadow: widget.isPrimary
                  ? <BoxShadow>[
                      BoxShadow(
                        color: widget.accent.withAlpha(_hovered ? 80 : 50),
            ...
            child: AnimatedSwitcher(
              ...
              child: Icon(
                ...
                color: widget.isPrimary
                    ...
                    : (widget.enabled
                        ? (widget.active ? widget.accent : widget.onSurface.withAlpha(170))
                        : widget.onSurface.withAlpha(55)),
              ),
            ),
          ),
        ),
    ...
    return Row(
      children: <Widget>[
        ...
        Text(label.toUpperCase(),
            style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800, letterSpacing: 0.45, color: onSurface)),
        if (!hideCount) ...<Widget>[
          const SizedBox(width: 6),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
            decoration: BoxDecoration(color: accent.withAlpha(24), borderRadius: BorderRadius.circular(999)),
...
class _IconPill extends StatelessWidget {
  const _IconPill({required this.icon, required this.accent});
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 32,
      height: 32,
      decoration: BoxDecoration(color: accent.withAlpha(20), borderRadius: BorderRadius.circular(9)),
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: _hovered ? widget.accent.withAlpha(14) : widget.onSurface.withAlpha(7),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: _hovered ? widget.accent.withAlpha(48) : widget.onSurface.withAlpha(14)),
        ),
        child: Row(
          children: <Widget>[
            _IconPill(icon: widget.icon, accent: widget.accent),
            const SizedBox(width: 8),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    (_RowAction action) => Tooltip(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Icon(action.icon, size: 14, color: widget.accent),
                        ),
                      ),
                    ),
                  )
...
class _MiniIconButton extends StatelessWidget {
  const _MiniIconButton({required this.icon, required this.accent, required this.onSurface, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(
        padding: const EdgeInsets.all(6),
        child: Icon(icon, size: 16, color: accent.withAlpha(220)),
      ),
    );
  }
}
...
class _InlinePanel extends StatelessWidget {
  const _InlinePanel(
      {required this.icon, required this.title, required this.subtitle, required this.accent, required this.onSurface});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: <Widget>[
          _IconPill(icon: icon, accent: accent),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text(title, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: onSurface)),
                const SizedBox(height: 2),
                Text(subtitle, style: TextStyle(fontSize: 11, color: onSurface.withAlpha(135))),
              ],
            ),
          ),
        ],
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Icon(icon, size: 42, color: accent.withAlpha(170)),
            ...
            Text(subtitle,
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 12, color: onSurface.withAlpha(140), height: 1.25)),
...
class _StatusStrip extends StatelessWidget {
  const _StatusStrip({required this.message, required this.accent, required this.onClose});
  ...
  Widget build(BuildContext context) {
    return Container(
      color: globalSettings.themeColors.background,
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            const SizedBox(width: 8),
            Expanded(child: Text(message, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: accent))),
            InkWell(
              onTap: onClose,
              borderRadius: BorderRadius.circular(10),
              child: Padding(
