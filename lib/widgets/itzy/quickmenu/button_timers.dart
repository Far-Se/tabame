      ...
      icon: Boxes.quickTimers.isNotEmpty
          ? Align(
              ...
              child: Text(
                remainingTimer,
                softWrap: false,
                style: TextStyle(fontSize: 9, overflow: TextOverflow.fade, color: userSettings.themeColors.text),
              ),
            )
...
class _ActiveTimerRowState extends State<_ActiveTimerRow> {
  ...
  @override
  Widget build(BuildContext context) {
    final Color rowAccent = widget.overdue ? Colors.orange : userSettings.themeColors.accent;
            ...
            child: Row(
              children: <Widget>[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: userSettings.themeColors.accent.withAlpha(28),
                    borderRadius: BorderRadius.circular(6),
                  ),
                  child: Text(
                    "${widget.minutes}m",
                ...
                AnimatedOpacity(
                  ...
                  child:
                      Icon(Icons.play_arrow_rounded, size: 13, color: userSettings.themeColors.accent.withAlpha(170)),
                ),
