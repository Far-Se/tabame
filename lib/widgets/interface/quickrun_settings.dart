  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        const InfoText(
            "You can access QuickRun directly from QuickMenu, just start typing. On triggers, last one is always regex aware!\nYou can navigate between results using TAB and arrows."),
