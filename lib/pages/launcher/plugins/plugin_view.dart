...
class _PluginViewState extends State<PluginView> {
                  ...
                  children: <Widget>[
                    ...
                    if (zone.hint.isNotEmpty)
                      Text(zone.hint,
                          ...
                          style: TextStyle(fontSize: Design.baseFontSize + 1.5, color: Design.text.withAlpha(90))),
                  ]),
            ),
          ]),
        ),
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Text(breadcrumbs[index].label,
                    style: TextStyle(fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(115))),
              ),
            ),
          ],
            ...
            if (caption != null && caption.isNotEmpty) ...<Widget>[
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: Design.baseFontSize + 2.5, color: Design.text.withAlpha(150)),
                ),
              ),
            ],
          ],
    ...
    if (empty == null) {
      return Center(
        child: Text(frame.emptyText,
            style: TextStyle(fontSize: Design.baseFontSize + 3, color: Design.text.withAlpha(120))),
      );
    }
    return Center(
      child: Column(
        ...
        children: <Widget>[
          ...
          if (empty.title.isNotEmpty)
            Text(
              empty.title,
              style: TextStyle(
                  fontSize: Design.baseFontSize + 3, fontWeight: FontWeight.w600, color: Design.text.withAlpha(190)),
            ),
          if (empty.hint.isNotEmpty) ...<Widget>[
            const SizedBox(height: 3),
            Text(empty.hint, style: TextStyle(fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(110))),
          ],
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          const SizedBox(width: 8),
          Text('Loading more…', style: TextStyle(fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(110))),
        ],
      ),
    );
  }
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
              label,
              style: TextStyle(
                  fontSize: Design.baseFontSize + 1.5, fontWeight: FontWeight.w700, color: Design.text.withAlpha(115)),
            ),
          ),
          Expanded(child: Container(height: 1, color: Design.text.withAlpha(20))),
        ],
      ...
      return SizedBox(
        ...
        child: editing
            ? TextField(
                ...
                autofocus: true,
                style: TextStyle(fontSize: Design.baseFontSize + 2.5, color: Design.text),
                  ...
                  child: Text(
                    ...
                    textAlign: column.align == 'end'
                        ...
                        : column.align == 'center'
                            ? TextAlign.center
                            : TextAlign.left,
                    style: TextStyle(fontSize: Design.baseFontSize + 2.5, color: Design.text.withAlpha(200)),
                  ),
                ),
              ),
      );
                    ...
                    child: Row(children: <Widget>[
                      ...
                      Expanded(
                          child: Text(frame.items[i].title,
                              ...
                              overflow: TextOverflow.ellipsis,
                              style:
                                  TextStyle(fontSize: Design.baseFontSize + 2.5, color: Design.text.withAlpha(210)))),
  ...
  Widget _diffHeader(String label) => Container(
        ...
        child: Text(label,
            style: TextStyle(
                fontSize: Design.baseFontSize + 2, fontWeight: FontWeight.w700, color: Design.text.withAlpha(150))),
      );
    ...
    return WindowsScrollView(
      child: Padding(
        ...
        child: !hasMarkdown && !hasDiff && item.previewImageUrl == null && item.previewMetadata.isEmpty
            ? Text('No preview',
                style: TextStyle(fontSize: Design.baseFontSize + 2.5, color: Design.text.withAlpha(90)))
            : _selectableContent(
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
  ...
  MarkdownConfig _markdownConfig({double maxImageWidth = double.infinity}) {
    ...
    return MarkdownConfig(
      configs: <WidgetConfig>[
        PConfig(textStyle: TextStyle(color: text, fontSize: Design.baseFontSize + 3, height: 1.5)),
        ...
        PreConfig(
          textStyle: TextStyle(fontFamily: 'Consolas', fontSize: Design.baseFontSize + 2.5, height: 1.45),
        ...
        TableConfig(
          ...
          headerStyle: TextStyle(fontSize: Design.baseFontSize + 2.5, fontWeight: FontWeight.w700, color: accent),
          bodyStyle: TextStyle(fontSize: Design.baseFontSize + 2.5, color: text),
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text(
                action.title,
                style:
                    TextStyle(fontSize: Design.baseFontSize + 2.5, fontWeight: FontWeight.w700, color: Design.accent),
              ),
            ],
          ),
        ),
  ...
  Widget _chatAvatarFallback() {
    ...
    return Container(
      ...
      child: Text(
        initial,
        style: TextStyle(
            fontSize: Design.baseFontSize + 2.5, fontWeight: FontWeight.w700, color: Design.accent.withAlpha(225)),
      ),
    );
  }
}
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  _DiscordChatBody(
                    ...
                    maxLines: 2,
                    style:
                        TextStyle(fontSize: Design.baseFontSize + 2, height: 1.25, color: Design.text.withAlpha(135)),
                  ),
                ],
              ),
            ),
      ...
      child: Row(children: <Widget>[
        ...
        Expanded(
          child: Text(
            ...
            overflow: TextOverflow.ellipsis,
            style: TextStyle(
                fontSize: Design.baseFontSize + 2.5, fontWeight: FontWeight.w700, color: Design.text.withAlpha(220)),
          ),
        ),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                ...
                if (item.subtitle.isNotEmpty || calendar.location.isNotEmpty)
                  Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(fontSize: Design.baseFontSize + 1.5, color: Design.text.withAlpha(105)),
                  ),
              ]),
            ),
          ]),
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
          ...
          Text(
            control.multiple && activeCount > 0
                ...
                : selected.label,
            style: TextStyle(
                fontSize: Design.baseFontSize + 2, fontWeight: FontWeight.w600, color: Design.text.withAlpha(185)),
          ),
          const SizedBox(width: 4),
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              ...
              if (banner.message.isNotEmpty)
                Text(banner.message,
                    style:
                        TextStyle(fontSize: Design.baseFontSize + 2, height: 1.3, color: Design.text.withAlpha(145))),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              ...
              if (item.subtitle.isNotEmpty) ...<Widget>[
                ...
                Text(item.subtitle,
                    ...
                    overflow: TextOverflow.ellipsis,
                    style:
                        TextStyle(fontSize: Design.baseFontSize + 2, height: 1.3, color: Design.text.withAlpha(125))),
              ],
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
        SizedBox(
          ...
          child: Text(line.oldLine?.toString() ?? '',
              ...
              style: TextStyle(
                  fontFamily: 'Consolas', fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(70))),
        ),
        const SizedBox(width: 8),
        SizedBox(
          width: 42,
        ...
        Text(
            line.type == 'add'
                ...
                : line.type == 'remove'
                    ? '-'
                    : ' ',
            style: TextStyle(fontFamily: 'Consolas', fontSize: Design.baseFontSize + 2.5, color: tint)),
        const SizedBox(width: 5),
        Expanded(
          ...
          if (line.timestamp.isNotEmpty)
            SizedBox(
              ...
              child: Text(line.timestamp,
                  style: TextStyle(
                      fontFamily: 'Consolas', fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(80))),
            ),
          SizedBox(
            width: 52,
          ...
          if (line.source.isNotEmpty)
            SizedBox(
              ...
              child: Text(line.source,
                  ...
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(
                      fontFamily: 'Consolas', fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(105))),
            ),
          Expanded(
            child: Text(line.text,
                ...
                style: TextStyle(
                    fontFamily: 'Consolas',
                    fontSize: Design.baseFontSize + 2.8,
                    height: 1.35,
                    color: Design.text.withAlpha(205))),
          ),
        ]),
          ...
          Expanded(
            ...
            if (operation.detail.isNotEmpty)
              Text(operation.detail,
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(130))),
          ])),
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
          SizedBox(
              ...
              child: Text(item.timestamp ?? '',
                  style: TextStyle(fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(125)))),
          Column(children: <Widget>[
          ...
          Expanded(
            ...
            if (item.subtitle.isNotEmpty)
              Text(item.subtitle,
                  maxLines: item.subtitleLines,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(fontSize: Design.baseFontSize + 2, color: Design.text.withAlpha(145)))
          ])),
        ]),
      );
}
      ...
      leftTitles: AxisTitles(
        axisNameWidget: widget.options.yTitle == null
            ...
            : Text(widget.options.yTitle!,
                style: TextStyle(fontSize: Design.baseFontSize + 1.5, color: Design.text.withAlpha(100))),
        sideTitles: SideTitles(
          showTitles: show,
          reservedSize: 42,
          getTitlesWidget: (double value, TitleMeta meta) => Text(
            value.abs() >= 1000 ? value.toStringAsFixed(0) : value.toStringAsFixed(value.abs() < 10 ? 1 : 0),
            style: TextStyle(fontSize: Design.baseFontSize + 1.5, color: Design.text.withAlpha(95)),
          ),
        ),
      ),
          ...
          touchTooltipData: BarTouchTooltipData(
            getTooltipItem: (BarChartGroupData group, int groupIndex, BarChartRodData rod, int rodIndex) {
              ...
              return BarTooltipItem(
                ...
                TextStyle(
                    fontSize: Design.baseFontSize + 2, fontWeight: FontWeight.w600, color: _seriesColor(rodIndex)),
              );
            },
          ),
        ),
        ...
        if (widget.title != null)
          Padding(
              ...
              child: Text(widget.title!,
                  style:
                      TextStyle(fontSize: Design.baseFontSize + 3.5, fontWeight: FontWeight.w700, color: Design.text))),
        Expanded(
          child: LayoutBuilder(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Text(action.title,
                    style: TextStyle(fontSize: Design.baseFontSize + 2, fontWeight: FontWeight.w700, color: color)),
              ],
            ),
          ),
        ),
      ...
      children: <Widget>[
        ...
        if (item.subtitle.isNotEmpty)
          Text(
            ...
            overflow: TextOverflow.ellipsis,
            textAlign: TextAlign.center,
            style: TextStyle(fontSize: Design.baseFontSize + 1.5, color: labelColor.withAlpha(130)),
          ),
      ],
    );
