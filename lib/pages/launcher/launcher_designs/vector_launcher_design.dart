...
BoxDecoration _vectorOuterDecoration(Color surface) => BoxDecoration(
...
class VectorLauncherFrame extends StatelessWidget {
  const VectorLauncherFrame({super.key, required this.child, required this.resultCount});
  final Widget child;
...
class _VectorLauncherSearchBar extends StatelessWidget {
  const _VectorLauncherSearchBar(this.content);
