...
class SteamLauncherFrame extends StatelessWidget {
  const SteamLauncherFrame({super.key, required this.child, required this.resultCount});
  final Widget child;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: _steamOuterDecoration(surface),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(Design.borderRadius),
          ...
          Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
            ...
            Container(
              ...
              child: Row(children: <Widget>[
                ...
                Text('ONLINE',
                    style: TextStyle(
                        color: onSurface.withAlpha(115), fontSize: 9, fontWeight: FontWeight.w600, letterSpacing: 1.2)),
                const Spacer(),
...
class _SteamLauncherSearchBar extends StatelessWidget {
  const _SteamLauncherSearchBar(this.content);
