    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
        Row(crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
          ...
          if (content.isSearching) const Padding(padding: EdgeInsets.only(left: 8), child: _TuiSearchSpinner()),
        ]),
        if (content.trailingBadge != null)
          Padding(padding: const EdgeInsets.only(top: 4), child: content.trailingBadge!),
      ]),
    );
  }
}
...
class TuiLauncherFrame extends StatelessWidget {
  const TuiLauncherFrame({super.key, required this.child, this.resultCount = 0});
