...
class LauncherState extends State<Launcher> with QuickMenuTriggers, SingleTickerProviderStateMixin {
  ...
  KeyEventResult _onKeyEvent(FocusNode node, KeyEvent event) {
    ...
    if (event is KeyDownEvent || event is KeyRepeatEvent) {
      if (event is KeyDownEvent &&
        ...
        unawaited(Boxes.pref.setBool(_filePreviewVisiblePreferenceKey, nextVisibility));
        return KeyEventResult.handled;
      }
  ...
  Widget build(BuildContext context) {
                ...
                : isWindowsXp
                    ...
                    : isWindows98
                        ...
                        : isNotion
                            ...
                            : Design.accent;
    final ThemeData designTheme = isRaycast
        ? baseTheme.copyWith(
                                                ...
                                                : isOrbit
                                                    ...
                                                    : isRelay
                                                        ? baseTheme.copyWith(
                                                            ...
                                                            highlightColor: accent.withAlpha(30),
                                                            textTheme:
                                                                GoogleFonts.encodeSansTextTheme(baseTheme.textTheme)
                                                                    .apply(
                                                        ...
                                                        : isSwitchboard
                                                            ? baseTheme.copyWith(
                                                                ...
                                                                highlightColor: accent.withAlpha(28),
                                                                textTheme:
                                                                    GoogleFonts.publicSansTextTheme(baseTheme.textTheme)
                                                                        .apply(
    ...
    final Widget frame = switch (_design) {
      ...
      LauncherDesign.relay => RelayLauncherFrame(
          surface: theme.colorScheme.surface,
          accent: accent,
          resultCount: _results.length,
          child: innerContent,
        ),
      LauncherDesign.newCast => RaycastLauncherFrame(
          surface: theme.colorScheme.surface,
          accent: accent,
          onSurface: onSurface,
          child: innerContent,
        ),
      LauncherDesign.terminal2 => Terminal2LauncherFrame(
          surface: theme.colorScheme.surface,
          accent: accent,
          onSurface: onSurface,
          resultCount: _results.length,
