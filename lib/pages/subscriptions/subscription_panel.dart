...
import '../../widgets/widgets/modal_button.dart';
import '../../widgets/widgets/modern_dropdown.dart';
import '../../widgets/widgets/panel_header.dart';
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <String>["M", "T", "W", "T", "F", "S", "S"].map((String d) {
              return Text(
                d,
                style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: onSurface.withValues(alpha: 0.5)),
              );
            }).toList(),
          ),
