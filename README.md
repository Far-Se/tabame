...
1. Point your assistant at `plugins/TABAME_PLUGIN_SKILL.md` (or `plugins/TABAME_PLUGIN_SKILL.min.md`) in this repo - it's the full, authoritative spec: every message type, render-frame field, view type and icon name, plus a matching `plugin.json` template.
