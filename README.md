...
Installs are cached and only re-run when your dependency list changes, so normal launches stay instant. Full details (including the `"env"` key for custom environment variables) are in `skills/TABAME_PLUGIN_SKILL.md`, §4.1.
