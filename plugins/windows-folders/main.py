...
FOLDERS = [
    {"id": "appdata-roaming", "name": "AppData (Roaming)", "keywords": ["appdata", "roaming"],
     "guid": "{3EB685DB-65F9-4CF6-A03A-E3EF65729F3D}"},
    {"id": "appdata-local", "name": "Local AppData", "keywords": ["appdata", "local"],
     "guid": "{F1B32785-6FBA-4FCF-9D55-7B8E7F157091}"},
    {"id": "appdata-locallow", "name": "LocalLow AppData", "keywords": ["appdata", "locallow", "low"],
     "guid": "{A520A1A4-1780-4FF6-BD18-167343C5AF16}"},
    {"id": "desktop", "name": "Desktop", "keywords": ["desktop"],
     "guid": "{B4BFCC3A-DB2C-424C-B029-7FE99A87C641}"},
    {"id": "documents", "name": "Documents", "keywords": ["documents", "my documents"],
     "guid": "{FDD39AD0-238F-46AF-ADB4-6C85480369C7}"},
    {"id": "downloads", "name": "Downloads", "keywords": ["downloads"],
     "guid": "{374DE290-123F-4565-9164-39C4925E467B}"},
    {"id": "pictures", "name": "Pictures", "keywords": ["pictures", "photos"],
     "guid": "{33E28130-4E1E-4676-835A-98395C3BC3BB}"},
    {"id": "music", "name": "Music", "keywords": ["music"],
     "guid": "{4BD8D571-6D19-48D3-BE97-422220080E43}"},
    {"id": "videos", "name": "Videos", "keywords": ["videos", "movies"],
     "guid": "{18989B1D-99B5-455B-841C-AB7C74E4DDFC}"},
    {"id": "favorites", "name": "Favorites", "keywords": ["favorites", "bookmarks"],
     "guid": "{1777F761-68AD-4D8A-87BD-30B759FA33DD}"},
    {"id": "startup", "name": "Startup", "keywords": ["startup", "autostart", "run"],
     "guid": "{B97D20BB-F46A-4C97-BA10-5E3608430854}"},
    {"id": "start-menu", "name": "Start Menu", "keywords": ["start menu", "startmenu"],
     "guid": "{625B53C3-AB48-4EC2-8FD8-C6C2E39A5FF9}"},
    {"id": "programs", "name": "Start Menu Programs", "keywords": ["programs", "start menu programs"],
     "guid": "{A77F5D77-2E2B-44C3-A6A2-ABA601054A51}"},
    {"id": "recent", "name": "Recent Items", "keywords": ["recent"],
     "guid": "{AE50C081-EBD2-438A-8655-8A092E34987A}"},
    {"id": "sendto", "name": "SendTo", "keywords": ["sendto", "send to"],
     "guid": "{8983036C-27C0-404B-8F08-102D10DCFD74}"},
    {"id": "templates", "name": "Templates", "keywords": ["templates"],
     "guid": "{A63293E8-664E-48DB-A079-83A65DE1EAAA}"},
    {"id": "quicklaunch", "name": "Quick Launch", "keywords": ["quicklaunch", "quick launch"],
     "guid": None, "manual": "quicklaunch"},
    {"id": "public", "name": "Public", "keywords": ["public"],
     "guid": "{DFDF76A2-C82A-4D63-906A-5644AC457385}"},
    {"id": "public-desktop", "name": "Public Desktop", "keywords": ["public desktop", "public"],
     "guid": "{C4AA340D-F20F-4863-AFEF-F87EF2E6BA25}"},
    {"id": "public-documents", "name": "Public Documents", "keywords": ["public documents", "public"],
     "guid": "{ED4824AF-DCE4-45A8-81E2-FC7965083634}"},
    {"id": "public-downloads", "name": "Public Downloads", "keywords": ["public downloads", "public"],
     "guid": "{3D644C9B-1FB8-4F30-9B45-F670235F79C0}"},
    {"id": "programdata", "name": "ProgramData", "keywords": ["programdata", "program data"],
     "guid": "{62AB5D82-FDC1-4DC3-A9DD-070D1D495D97}"},
    {"id": "program-files", "name": "Program Files", "keywords": ["program files", "programfiles"],
     "guid": "{6D809377-6AF0-444B-8957-A3773F02200E}"},
    {"id": "program-files-x86", "name": "Program Files (x86)",
     "keywords": ["program files x86", "programfiles(x86)"],
     "guid": "{7C5A40EF-A0FB-4BFC-874A-C0F2E0B9FA8E}"},
    {"id": "windows", "name": "Windows", "keywords": ["windows", "winsxs"],
     "guid": "{F38BF404-1D43-42F2-9305-67DE0B28FC23}"},
    {"id": "system32", "name": "System32", "keywords": ["system32", "system"],
     "guid": "{1AC14E77-02E7-4E5D-B744-2EB1AE5198B7}"},
    {"id": "fonts", "name": "Fonts", "keywords": ["fonts"],
     "guid": "{FD228CB7-AE11-4AE3-864C-16F3910AB8FE}"},
    {"id": "savedgames", "name": "Saved Games", "keywords": ["saved games", "savedgames", "games"],
     "guid": "{4C5C32FF-BB9D-43B0-B5B4-2D72E54EAAA4}"},
    {"id": "cookies", "name": "Cookies", "keywords": ["cookies"],
     "guid": "{2B0F765D-C0E9-4171-908E-08A611B84FF6}"},
    {"id": "history", "name": "History", "keywords": ["history"],
     "guid": "{D9DC8A3B-B784-432E-A781-5A1130A75963}"},
    {"id": "inetcache", "name": "Temporary Internet Files",
     "keywords": ["inetcache", "internet cache", "temp internet"],
     "guid": "{352481E8-33BE-4251-BA85-6007CAEDCF9D}"},
    {"id": "nethood", "name": "Network Shortcuts", "keywords": ["nethood", "network shortcuts"],
     "guid": "{C5ABBF53-E17F-4121-8900-86626FC2C973}"},
    {"id": "printhood", "name": "Printer Shortcuts", "keywords": ["printhood", "printer shortcuts"],
     "guid": "{9274BD8D-CFD1-41C3-B35E-B13F55A758F4}"},
    {"id": "temp", "name": "Temp", "keywords": ["temp", "temporary"],
     "guid": None, "manual": "temp"},
    {"id": "profile", "name": "User Profile", "keywords": ["profile", "home", "userprofile"],
...
def handle_action(item_id, action):
    ...
    if not p:
        send({
            "type": "command", "command": "toast",
            "text": "That folder isn't available on this system.", "style": "error",
        })
        return
    ...
    if not os.path.isdir(p):
        send({
            "type": "command", "command": "toast",
            "text": f"Folder not found: {p}", "style": "error",
        })
        return
