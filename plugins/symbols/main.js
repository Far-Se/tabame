...
const symbols = [
  ...
  { char: "⁰", name: "Superscript Zero", tags: "math superscript raised exponent power zero 0" },
  { char: "¹", name: "Superscript One", tags: "math superscript raised exponent power one 1" },
  { char: "²", name: "Superscript Two", tags: "math superscript raised exponent power squared 2" },
  { char: "³", name: "Superscript Three", tags: "math superscript raised exponent power cubed 3" },
  { char: "⁴", name: "Superscript Four", tags: "math superscript raised exponent power four 4" },
  { char: "⁵", name: "Superscript Five", tags: "math superscript raised exponent power five 5" },
  { char: "⁶", name: "Superscript Six", tags: "math superscript raised exponent power six 6" },
  { char: "⁷", name: "Superscript Seven", tags: "math superscript raised exponent power seven 7" },
  { char: "⁸", name: "Superscript Eight", tags: "math superscript raised exponent power eight 8" },
  { char: "⁹", name: "Superscript Nine", tags: "math superscript raised exponent power nine 9" },
  { char: "⁺", name: "Superscript Plus", tags: "math superscript raised plus operator" },
  { char: "⁻", name: "Superscript Minus", tags: "math superscript raised minus operator" },
  { char: "⁼", name: "Superscript Equals", tags: "math superscript raised equals operator" },
  { char: "⁽", name: "Superscript Left Parenthesis", tags: "math superscript raised left parenthesis bracket" },
  { char: "⁾", name: "Superscript Right Parenthesis", tags: "math superscript raised right parenthesis bracket" },
  { char: "ⁱ", name: "Superscript I", tags: "math superscript raised letter i" },
  { char: "ⁿ", name: "Superscript N", tags: "math superscript raised letter n" },
  { char: "₀", name: "Subscript Zero", tags: "math subscript lowered index zero 0" },
  { char: "₁", name: "Subscript One", tags: "math subscript lowered index one 1" },
  { char: "₂", name: "Subscript Two", tags: "math subscript lowered index two 2" },
  { char: "₃", name: "Subscript Three", tags: "math subscript lowered index three 3" },
  { char: "₄", name: "Subscript Four", tags: "math subscript lowered index four 4" },
  { char: "₅", name: "Subscript Five", tags: "math subscript lowered index five 5" },
  { char: "₆", name: "Subscript Six", tags: "math subscript lowered index six 6" },
  { char: "₇", name: "Subscript Seven", tags: "math subscript lowered index seven 7" },
  { char: "₈", name: "Subscript Eight", tags: "math subscript lowered index eight 8" },
  { char: "₉", name: "Subscript Nine", tags: "math subscript lowered index nine 9" },
  { char: "₊", name: "Subscript Plus", tags: "math subscript lowered plus operator" },
  { char: "₋", name: "Subscript Minus", tags: "math subscript lowered minus operator" },
  { char: "₌", name: "Subscript Equals", tags: "math subscript lowered equals operator" },
  { char: "₍", name: "Subscript Left Parenthesis", tags: "math subscript lowered left parenthesis bracket" },
  { char: "₎", name: "Subscript Right Parenthesis", tags: "math subscript lowered right parenthesis bracket" },
  { char: "ᵢ", name: "Subscript I", tags: "math subscript lowered letter i" },
  { char: "ₙ", name: "Subscript N", tags: "math subscript lowered letter n" },

  // Additional Fractions
  { char: "⅐", name: "One Seventh", tags: "math fraction 1/7 seventh" },
  { char: "⅑", name: "One Ninth", tags: "math fraction 1/9 ninth" },
  { char: "⅒", name: "One Tenth", tags: "math fraction 1/10 tenth" },
  { char: "⅕", name: "One Fifth", tags: "math fraction 1/5 fifth" },
  { char: "⅖", name: "Two Fifths", tags: "math fraction 2/5 fifths" },
  { char: "⅗", name: "Three Fifths", tags: "math fraction 3/5 fifths" },
  { char: "⅘", name: "Four Fifths", tags: "math fraction 4/5 fifths" },
  { char: "⅙", name: "One Sixth", tags: "math fraction 1/6 sixth" },
  { char: "⅚", name: "Five Sixths", tags: "math fraction 5/6 sixths" },
  { char: "⅛", name: "One Eighth", tags: "math fraction 1/8 eighth" },
  { char: "⅜", name: "Three Eighths", tags: "math fraction 3/8 eighths" },
  { char: "⅝", name: "Five Eighths", tags: "math fraction 5/8 eighths" },
  { char: "⅞", name: "Seven Eighths", tags: "math fraction 7/8 eighths" },
  { char: "⅔", name: "Two Thirds", tags: "math fraction 2/3 thirds" },
  { char: "¾", name: "Three Quarters", tags: "math fraction 3/4 quarter fourth" },

  // Diagonal Arrows
  { char: "↗", name: "North East Arrow", tags: "arrow diagonal up right northeast" },
  { char: "↘", name: "South East Arrow", tags: "arrow diagonal down right southeast" },
  { char: "↙", name: "South West Arrow", tags: "arrow diagonal down left southwest" },
  { char: "↖", name: "North West Arrow", tags: "arrow diagonal up left northwest" },
  { char: "↕", name: "Up Down Arrow", tags: "arrow vertical up down" },

  // Currency & Keyboard Symbols
  { char: "$", name: "Dollar Sign", tags: "currency dollar usd money" },
  { char: "₪", name: "New Sheqel", tags: "currency israel israeli shekel sheqel money" },
  { char: "₦", name: "Naira", tags: "currency nigerian naira money" },
  { char: "฿", name: "Thai Baht", tags: "currency thailand thai baht money" },
  { char: "₭", name: "Kip", tags: "currency laotian lao kip money" },
  { char: "₮", name: "Tugrik", tags: "currency mongolian tugrik tögrög money" },
  { char: "₾", name: "Lari", tags: "currency georgian lari money" },
  { char: "@", name: "At Sign", tags: "punctuation at email mention keyboard" },
  { char: "#", name: "Number Sign", tags: "punctuation number hash hashtag pound octothorpe" },
  { char: "&", name: "Ampersand", tags: "punctuation typography and keyboard" },
  { char: "%", name: "Percent Sign", tags: "punctuation percentage percent keyboard" },
  { char: "+", name: "Plus Sign", tags: "math addition plus keyboard" },
  { char: "=", name: "Equals Sign", tags: "math equality equals keyboard" },

  // Circled Numbers
  { char: "①", name: "Circled One", tags: "number circled list 1 first" },
  { char: "②", name: "Circled Two", tags: "number circled list 2 second" },
  { char: "③", name: "Circled Three", tags: "number circled list 3 third" },
  { char: "④", name: "Circled Four", tags: "number circled list 4 fourth" },
  { char: "⑤", name: "Circled Five", tags: "number circled list 5 fifth" },
  { char: "⑥", name: "Circled Six", tags: "number circled list 6 sixth" },
  { char: "⑦", name: "Circled Seven", tags: "number circled list 7 seventh" },
  { char: "⑧", name: "Circled Eight", tags: "number circled list 8 eighth" },
  { char: "⑨", name: "Circled Nine", tags: "number circled list 9 ninth" },
  { char: "⑩", name: "Circled Ten", tags: "number circled list 10 tenth" },

  // Common Signs & Shapes
  { char: "⚠", name: "Warning Sign", tags: "sign caution warning alert danger" },
  { char: "♻", name: "Recycling Symbol", tags: "sign recycle recycling environment" },
  { char: "⚡", name: "High Voltage", tags: "sign lightning electricity electric danger" },
  { char: "☎", name: "Telephone", tags: "symbol phone telephone contact" },
  { char: "✉", name: "Envelope", tags: "symbol mail email letter message" },
  { char: "☀", name: "Sun", tags: "weather sun sunny sunshine day" },
  { char: "☂", name: "Umbrella", tags: "weather rain umbrella" },
  { char: "☮", name: "Peace", tags: "symbol peace sign" },
  { char: "⚙", name: "Gear", tags: "symbol gear settings cog" },
  { char: "♡", name: "White Heart Suit", tags: "symbol heart love white outline" },
  { char: "□", name: "White Square", tags: "shape square white outline empty" },
  { char: "▲", name: "Black Up Triangle", tags: "shape triangle black up" },
  { char: "△", name: "White Up Triangle", tags: "shape triangle white up outline" },
  { char: "▼", name: "Black Down Triangle", tags: "shape triangle black down" },
  { char: "▽", name: "White Down Triangle", tags: "shape triangle white down outline" },
  { char: "◆", name: "Black Diamond", tags: "shape diamond black filled" },
  { char: "◇", name: "White Diamond", tags: "shape diamond white outline" },
